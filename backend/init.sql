...
-- SEED DATA (11 Sample Skills)
INSERT INTO arts (skill_id, name_jp, name_en, description, base_power, attribute, system_type, mp_cost, bp_cost, target_type, inspiration_source, chain_compatibility, combo, timing, stance, charges, repeat_penalty, spark, ai_tags, visual_effect_instruction, sound_effect_instruction, cooldown_turns) VALUES 
